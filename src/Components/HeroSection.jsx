          ...
          <div className="heroContent flex flex-col justify-between">
            <div className="heroHeading">
              <h1 className="uppercase font-bold text-4xl sm:text-6xl md:text-6xl lg:text-7xl">
                CREATIVE <br />
                <span className="theme-text-secondary">Developer</span>
              </h1>
            </div>
            <div className=" heroBtns flex gap-5 mt-4">
            <button className="px-6 py-2 md:px-8 md:py-3 sm:px-4 sm:py-2 text-lg theme-bg-secondary rounded-4xl cursor-pointer transition">
    Hire Me
</button>
<button className="px-6 py-2 md:px-8 md:py-3 sm:px-4 sm:py-2 text-lg bg-[#393E46] hover:bg-gray-700 rounded-4xl cursor-pointer transition flex items-center">
    Download CV
    <Download className="inline ml-2" />
      ...
      <div className="relative heroSectionRight min-w-[30vw] flex items-end flex-[2] md:flex-[2] p-6 min-h-[50vh] order-1 md:order-2 ">
        ...
        <img
          src={heroRightVector}
          alt="Person Vector"
          className="relative z-10 w-[250px] h-[200px] md:w-[300px] md:h-[250px] -mb-15"
        />
      </div>
    </section>
  );
